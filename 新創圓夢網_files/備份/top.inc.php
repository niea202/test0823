...
<nav class="navbar">
	...
	<div class="container">
		<div id="menu" name="menu">
			...
			<div class="nav-menu">
				<ul class="menu-list">
					<li class="menu-item"><a href="#" class="menu-link" id="responses" title="問題反映">問題反映</a></li>
					<li class="menu-item"><a href="<?php echo $p_str_dotPath; ?>modules/download/" class="menu-link" title="下載專區">下載專區</a></li>
					<li class="menu-item"><a href="https://startup.sme.gov.tw/" onclick="trackOutboundLink('https://startup.sme.gov.tw/','<?=$formPage?>'); return false;" class="menu-link" title="SME English">English</a></li>
					<?php if(!(isset($user['name']) && !empty($user['name']) )):?>
					<li class="menu-item"><a href="<?php echo $p_str_dotPath; ?>modules/login" class="menu-link" title="登入/註冊">登入/註冊</a></li>
					<?php else:?>
					<li class="menu-item"><a href="<?php echo $p_str_dotPath; ?>modules/account" class="menu-link" title="會員中心">會員中心</a></li>
					<li class="menu-item"><a href="<?php echo $p_str_dotPath; ?>modules/account/logout.php" class="menu-link" title="登出系統">登出</a></li>
					<?php endif;?>
