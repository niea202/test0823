	...
	<div class="container">
		<div id="menu" name="menu">
			<div class="nav-main row">
				...
				<div class="logo d-inline-block" title="新創圓夢網">
			...
			<div class="nav-menu">
				<ul class="menu-list">
					<li class="menu-item"><a href="#" class="menu-link" id="responses" title="問題反映"><span>問題反映</span></a></li>
					<li class="menu-item"><a href="<?php echo $p_str_dotPath; ?>modules/download/" class="menu-link" title="下載專區"><span>下載專區</span></a></li>
					<li class="menu-item"><a href="https://startup.sme.gov.tw/" onclick="trackOutboundLink('https://startup.sme.gov.tw/','<?=$formPage?>'); return false;" class="menu-link" title="Foreigner info"><span style="font-size: 0.875rem;">Foreigner info</span></a></li>
			...
			<div class="nav-menu-cross">
				<div class="container">
					<ul class="menu-list-cross">
						<li class="menu-item">
							<a href="javascript:void(0);" class="menu-link" title="關於我們" data-id="1"><span class="menu-title">關於我們</span><span class="cross-more"><span class="cross-line"></span><span class="cross-line"></span></span></a>
							<ul class="more-list" id="more-list1">
								...
								<li><a href="https://startup.sme.gov.tw/" title="Startup Portal Taiwan" target="_blank">Startup Portal Taiwan</a></li>
						...
						<li class="menu-item">
							<a href="javascript:void(0);" class="menu-link" title="資源搜尋" data-id="2"><span class="menu-title">資源搜尋</span><span
							...
							<ul class="more-list" id="more-list2">
								...
								<li><a href="<?php echo $p_str_dotPath; ?>event/net_zero/" title="淨零排放資訊" target="_blank">淨零排放資訊</a></li>
							</ul>
						</li>
						<li class="menu-item">
							<a href="javascript:void(0);" class="menu-link" title="活動消息" data-id="3"><span class="menu-title">活動消息</span><span class="cross-more"><span class="cross-line"></span><span class="cross-line"></span></span></a>
						...
						<li class="menu-item">
							<a href="javascript:void(0);" class="menu-link" title="創業工具" data-id="4"><span class="menu-title">創業工具</span><span class="cross-more"><span class="cross-line"></span><span class="cross-line"></span></span></a>
						...
						<li class="menu-item">
							<a href="javascript:void(0);" class="menu-link" title="成果亮點" data-id="5"><span class="menu-title">成果亮點</span><span class="cross-more"><span class="cross-line"></span><span class="cross-line"></span></span></a>
